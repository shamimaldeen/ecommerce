	...
	<div class="container">
		<nav class="mb-3">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item"><a href="#">{{$singlebrand->brand_name}}</a></li>
    <!--	
				...
				<div style="" class="filter-content collapse show" id="collapse22">
					<div class="card-body">
						...
						<ul class="list-unstyled list-lg">
							...
							<li>
								<a href="{{ url('product/brand/'.$brand->id.'/'.str_replace(' ', '-', $brand->brand_name)) }}">{{$brand->brand_name}} <span class="float-right badge badge-light round">{{App\Http\Controllers\Front\ProductFront::procountbybrand($brand->id)}}</span>  </a>
							</li>
	...
	<main class="col-sm-9">
		<div id="code_prod2">
			<div class="row">
				...
				<p class="text-center">No Product Found for Brand, <strong></strong></p>
