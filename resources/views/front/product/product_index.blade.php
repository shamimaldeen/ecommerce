			...
			<article class="card-group-item">
				...
				<div class="filter-content collapse show" id="collapse33">
					<div class="card-body">
						...
						<form action="{{ url('search/price/') }}" method="get" class="pb-3"> 
							...
							<button type="submit" class="btn btn-block btn-outline-primary" id="search_by_price">Apply</button>
