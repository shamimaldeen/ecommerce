	...
	<div class="container">
		<nav class="mb-3">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item"><a href="#">{{$singlecategory->category_name}}</a></li>
    <!--	
				...
				<div style="" class="filter-content collapse show" id="collapse22">
					<div class="card-body">
						...
						<ul class="list-unstyled list-lg">
							...
							<li>
								<a href="{{ url('product/category/'.$category->id.'/'.str_replace(' ', '-', $category->category_name)) }}">{{$category->category_name}} <span class="float-right badge badge-light round">{{App\Http\Controllers\Front\ProductFront::procountbycategory($category->id)}}</span>  </a>
							</li>
				...
				<div class="filter-content collapse show" id="collapse33">
					<div class="card-body">
						<form action="{{ url('search/price/') }}" method="get" > 
							<input type="range" class="custom-range" id="range" min="0" max="10000" name="">
							<div class="form-row">
								<div class="form-group col-md-6">
									<label>Min</label>
									<input class="form-control" name="min" id="min" placeholder="$0" type="number">
								</div>
	...
	<main class="col-sm-9">
		<div id="code_prod2">
			<div class="row">
				...
				<p class="text-center">No Product Found for Category, <strong>{{$singlecategory->category_name}}</strong></p>
