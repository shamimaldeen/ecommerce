...
@section('title','Order Delivered - Ecommerce')
@section('breadcrubmb','Order Delivered ')
@section('content')
	...
	<table id="basicTable" class="table table-striped  table-hover">
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<a href="{{ url('admin/order/view/'.$order['id']) }}"  class="btn btn-warning btn-sm"><i class="fa fa-search"></i>  View</a>
