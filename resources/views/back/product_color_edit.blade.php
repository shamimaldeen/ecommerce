...
@endif
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form class="form-inline" method="post" action="{{url('admin/product/color/update/'.$id)}}" >
					{{csrf_field()}}
					<div class="form-group">
					 
						<input type="text" name="color_name" value="{{$colorsingle}}" class="form-control"  >
					</div><!-- form-group -->
                                        ...
                                        <tbody>
                                          ...
                                          <tr>
                                            ...
                                            <td>   
                                      		...
                                      		<a href="{{ url('admin/product-color-delete/'.$color->id) }}" data-toggle="tooltip" title="Edit" class="delete-row tooltips"><i class="fa fa-trash-o"></i></a>&nbsp;&nbsp;
