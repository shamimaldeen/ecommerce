...
@section('breadcrubmb','TRANSACTION Edit') 
@section('content')
<div class="contentpanel">
    ...
    @endif
		<div class="panel panel-default">
			<form method="post" action="{{url('admin/transaction/update/'.$transaction->id)}}" >
				@csrf
					...
					<div class="col-sm-4">
						<div class="form-group">
							...
							<div class="input-group">
								<input type="date" name="transaction_date" class="form-control" placeholder="mm/dd/yyyy" value="{{$transaction->transaction_date}}" id="datepicker">
						...
						<div class="form-group">
							...
							<select   data-placeholder="Choose One" name="category_id" class="form-control">
								...
								@foreach($categories as $category)
									<option value="{{$category->id}}" @if($category->id == $transaction->category_id) selected="" @endif>{{$category->category_name}}</option>
								@endforeach
				...
				<div class="row">
					...
					<div class="col-sm-2">
						<div class="form-group">
							...
							<input type="text" name="cash_pay" value="{{$transaction->cash_pay}}" class="form-control" />
						</div><!-- form-group -->
					</div><!-- col-sm-6 -->
					<div class="col-sm-2">
						<div class="form-group">
							<label class="control-label">Cash Receive</label>
							<input type="text" name="cash_receive" value="{{$transaction->cash_receive}}" class="form-control" />
						</div> 
					</div> 
